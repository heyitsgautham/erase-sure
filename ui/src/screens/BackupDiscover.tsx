...
function BackupDiscover() {
    ...
    const handleDeviceSelect = (device: Device) => {
        ...
        if (device.risk_level === 'CRITICAL') {
            message += ' (System disk - Backup allowed)';
            type = 'warning';
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div className="mb-6">
                <h2 className="font-semibold mb-4" style={{ fontSize: '1.5rem' }}>
                    📦 Backup Device Discovery
                </h2>
                <p style={{ color: '#64748b', marginBottom: '2rem' }}>
                    Scan and analyze storage devices for secure backup operations.
                    Select a device to continue with encrypted backup.
                </p>
            ...
            {criticalDeviceCount > 0 && (
                <div className="alert alert-warning mb-6">
                    ...
                    <p className="text-sm">
                        {criticalDeviceCount} device(s) are marked as CRITICAL (system disks).
                        Backup operations are allowed on system disks to preserve user data.
                    </p>
                </div>
            )}
                            ...
                            <div className="flex gap-4">
                                ...
                                >
                                    ...
                                    <div style={{ fontSize: '0.75rem', opacity: 0.8, marginTop: '0.25rem' }}>
                                        Encrypt and backup device data
                                    </div>
                                </button>
                            </div>
                        </div>
