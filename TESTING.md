...
Task: Examine the home screen Questions:
...
Task: Test the navigation system Questions:
...
Task: Click "Discover Devices" (or similar button) Questions:
...
Task: Select a device with "CRITICAL" or "HIGH" risk level Questions:
...
Task: Navigate to the wipe planning (should happen after selecting a device) Questions:
...
Task: Navigate to backup screen (try from home or after device selection) Questions:
...
Task: Navigate to certificates screen Questions:
...
Task: Test interactive elements Questions:
...
Task: Test data persistence across screens Questions:
...
Task: Try various interactions Questions:
